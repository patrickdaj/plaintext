...
| T19 | ✅ | PR build gate: `mkdocs build --strict` on pull_request (was push-to-main only) | P1 | plaintext | Sonnet 4.6 | S | — |
...
| T24 | ✅ | Cloud track build-vs-find rebalance — all 4 core items + 03/10 polish done, every lab make up/demo validated; new module 17 (KMS) | P1 | both | Sonnet 4.6 (Opus for KMS module) | M–L | — |
